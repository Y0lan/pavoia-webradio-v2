...
export function StreamsList({ streams, viewingId, playingId, isPlaying, onSelect }) {
  const order = {
        ...
        return (
          <button
            ...
            className={[
              ...
              isViewing
                ? `border-[${meta.accentColor}]/40 bg-white/5`
                : "border-white/10 hover:border-white/20 bg-white/[0.02]",
              isBus ? "opacity-70 italic" : "",
            ].join(" ")}
            style={isViewing ? { borderColor: meta.accentColor + "60" } : {}}
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                {isNowPlaying ? (
                  <span className="ml-auto flex-shrink-0"><EqualizerBars /></span>
                ) : null}
              </div>
